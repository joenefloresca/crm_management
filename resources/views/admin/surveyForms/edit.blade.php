    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.survey-forms.update", [$surveyForm->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('campaign') ? 'is-invalid' : '' }}" name="campaign_id" id="campaign_id">
                    @foreach($campaigns as $id => $campaign)
                        <option value="{{ $id }}" {{ (old('campaign_id') ? old('campaign_id') : $surveyForm->campaign->id ?? '') == $id ? 'selected' : '' }}>{{ $campaign }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('survey_name') ? 'is-invalid' : '' }}" type="text" name="survey_name" id="survey_name" value="{{ old('survey_name', $surveyForm->survey_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}" type="text" name="first_name" id="first_name" value="{{ old('first_name', $surveyForm->first_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" type="text" name="last_name" id="last_name" value="{{ old('last_name', $surveyForm->last_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address_1') ? 'is-invalid' : '' }}" type="text" name="address_1" id="address_1" value="{{ old('address_1', $surveyForm->address_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address_2') ? 'is-invalid' : '' }}" type="text" name="address_2" id="address_2" value="{{ old('address_2', $surveyForm->address_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address_3') ? 'is-invalid' : '' }}" type="text" name="address_3" id="address_3" value="{{ old('address_3', $surveyForm->address_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address_4') ? 'is-invalid' : '' }}" type="text" name="address_4" id="address_4" value="{{ old('address_4', $surveyForm->address_4) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" type="text" name="city" id="city" value="{{ old('city', $surveyForm->city) }}">
                @if($errors->has('city'))
                    <div class="invalid-feedback">
                        {{ $errors->first('city') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('state') ? 'is-invalid' : '' }}" type="text" name="state" id="state" value="{{ old('state', $surveyForm->state) }}">
                @if($errors->has('state'))
                    <div class="invalid-feedback">
                        {{ $errors->first('state') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('county') ? 'is-invalid' : '' }}" type="text" name="county" id="county" value="{{ old('county', $surveyForm->county) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text" name="country" id="country" value="{{ old('country', $surveyForm->country) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_number') ? 'is-invalid' : '' }}" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $surveyForm->phone_number) }}">
