...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-SurveyReponse">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search">
                                ...
                                @foreach($survey_forms as $key => $item)
                                    <option value="{{ $item->survey_name }}">{{ $item->survey_name }}</option>
                                @endforeach
                            </select>
                        </td>
                        <td>
...
@endcan
  ...
  let table = $('.datatable-SurveyReponse:not(.ajaxTable)').DataTable({ buttons: dtButtons })
