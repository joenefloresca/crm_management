<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('survey_question_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.survey-questions.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/survey-questions") || request()->is("admin/survey-questions/*") ? "c-active" : "" }}">
        ...
        @endcan
        @can('survey_reponse_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.survey-reponses.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/survey-reponses") || request()->is("admin/survey-reponses/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
