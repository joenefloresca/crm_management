...
class SurveyFormsApiController extends Controller
{
    public function index()
    {
        abort_if(Gate::denies('survey_form_access'), Response::HTTP_FORBIDDEN, '403 Forbidden');

        return new SurveyFormResource(SurveyForm::with(['campaign'])->get());
    }
    ...
    public function show(SurveyForm $surveyForm)
    {
        ...
        return new SurveyFormResource($surveyForm->load(['campaign']));
    }
